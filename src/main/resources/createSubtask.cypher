...
CREATE (a:Task {title: $title, expand: $expand, type: $type, done: $done, estimate: $estimate, due: $due, startTo: $startTo, availableFrom: $availableFrom})<-[:DEPENDS_ON {order: ord}]-(parent)
